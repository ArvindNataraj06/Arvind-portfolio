      ...
      <Container className="relative grid items-center gap-10 py-16 md:grid-cols-2 md:py-24">
        ...
        <div>
          ...
          <p className="mt-4 text-sm font-medium text-slate-700">
            Frontend Developer | Master’s Student in Applied Computer Science
          </p>

          <p className="mt-4 max-w-xl text-base leading-7 text-slate-600">
            I build clean, scalable, and user-focused web applications using React,
            TypeScript, and modern UI patterns.
          </p>
        ...
        <div className="flex justify-center md:justify-end">
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-lg">
              {/* Replace src with your image in src/assets/images */}
              <img
                src="/profile.jpg"
                alt="Arvind Nataraj"
